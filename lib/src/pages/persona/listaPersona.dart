  ...
  Widget build(BuildContext context) {
   final size = MediaQuery.of(context).size;
    return Scaffold(
      ...
      onPressed: (){
         Navigator.push(context, MaterialPageRoute(builder: (context) => formPersona(),),);
      }
    ),
      body: Column(
        children: [
                ...
                return snapshot.hasData
                          ...
                          return Container(
                            ...
                            child: ListTile(
                              leading: GestureDetector(
                                ...
                                onTap: () {
                                  Navigator.push(context, MaterialPageRoute(builder: (context) => formPersona(list: list,index: index,),),);
                              ...
                              trailing: GestureDetector(
                                ...
                                onTap: () {
                                  setState(() {
                            var url = Uri.parse("http://192.168.1.100/justy/borrarperson.php");
                            http.post(url,body: {
                    ...
                    : Container(
                      child: Column(
                        ...
                        children: [
                          Text('Cargando...', style: TextStyle(fontSize: 40, color: Colors.red),),
                        ],
                      ),);
              },
            ),
